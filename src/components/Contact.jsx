...
const Contact = () => {
  return (
    <div className='contact bg-[03002D] bg-gradient-to-b from-[#04002c] via-[#030031] to-[#040043] text-slate-300  px-16 md:px-20 lg:px-30 pt-12 py-4 min-h-screen h-fit'>
      ...
      <h2 className=' text-lg mb-4'>If you have any suggestions for my website or if you'd like to collaborate on future projects, please feel free to contact me through this form and also connect with me on my socials.
      </h2>
