      ...
      <div className='grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
         {myports.map(({pic,id,code,live,style})=>{
          ...
          <div className='py-4 flex gap-5 justify-center '>
            ...
            <a target='_blank' rel='noreferrer' href={live}><button className={`bg-black rounded-full px-3 py-0.5 font-bold text-lg hover:shadow-sm hover:shadow-yellow-500 ${style}`}>Live</button></a>
          </div>
         </div>
         })}
      </div>
