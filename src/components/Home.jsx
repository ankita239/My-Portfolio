...
const Home = () => {
  return (
    <div id='home' className='h-screen w-full flex flex-col  gap-16  md:flex-row justify-center items-center  px-16 md:px-20 lg:px-32  bg-[03002D] bg-gradient-to-b from-[#04002c] via-[#030031] to-[#040043] mt-20 md:mt-10'>
